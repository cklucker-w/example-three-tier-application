...
| Database | PostgreSQL 18.5 | managed by Docker / Cloud SQL |
...
1. **postgres** — PostgreSQL 18.5 database, waits until healthy
...
- Cloud SQL PostgreSQL 18.5 instance (private IP)
