...
| Database | PostgreSQL 18.7 | managed by Docker / Cloud SQL |
...
1. **postgres** — PostgreSQL 18.7 database, waits until healthy
...
- Cloud SQL PostgreSQL 18.7 instance (private IP)
