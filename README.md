...
| Database | PostgreSQL 18.2 | managed by Docker / Cloud SQL |
...
1. **postgres** — PostgreSQL 18.2 database, waits until healthy
...
- Cloud SQL PostgreSQL 18.2 instance (private IP)
