...
| Database | PostgreSQL 18.3 | managed by Docker / Cloud SQL |
...
1. **postgres** — PostgreSQL 18.3 database, waits until healthy
...
- Cloud SQL PostgreSQL 18.3 instance (private IP)
