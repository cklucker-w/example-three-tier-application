              ...
              >
                ...
                >
                  <svg viewBox="0 0 16 16" className="w-4 h-4" fill="currentColor">
                    ...
                    <path fillRule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 1a.5.5 0 0 0-.5.5v1h11V1.5a.5.5 0 0 0-.5-.5h-1V.5a.5.5 0 0 0-.5-.5h-2a.5.5 0 0 0-.5.5V1h-3V.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v.5H2.5z" />
                  </svg>
                </button>
              </form>
            </li>
