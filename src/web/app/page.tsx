import { getTasks, createTask, toggleTask, deleteTask, getTaskStats } from './actions';
    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-900 py-16 px-4">
      <div className="max-w-lg mx-auto">
        ...
        <div className="grid grid-cols-3 gap-4 mb-8">
          <div className="rounded-lg border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 px-4 py-3 text-center">
          ...
          {tasks.map((task) => (
            ...
            >
              ...
              >
                <button
                  type="submit"
                  className="text-zinc-400 hover:text-red-600 dark:hover:text-red-400 transition-colors flex-shrink-0"
